...
const PoolMonitor = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const fromTimestamp = dateFrom ? (new Date(`${dateFrom}T00:00:00`).getTime()/1000).toString() : undefined;
      const toTimestamp = dateTo ? (new Date(`${dateTo}T23:59:59`).getTime()/1000).toString() : undefined;
