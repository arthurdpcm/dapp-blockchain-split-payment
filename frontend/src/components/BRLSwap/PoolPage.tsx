...
import { TaxMonitorContainer, TaxMonitorHeader, TaxMonitorTitle, TaxMonitorDescription, TaxMonitorTotal } from '../TaxMonitor/TaxMonitor.styled';
...
const PoolPage = () => {
  ...
  if (!pool) {
    return (
      <TaxMonitorContainer>
        <TaxMonitorHeader>
          <TaxMonitorTitle>{t('pair')}: {id}</TaxMonitorTitle>
        </TaxMonitorHeader>
