...
1.  **Clone o Repositório:**
    ```bash
    git clone https://github.com/seu-usuario/dapp-blockchain-split-payment.git
    cd dapp-blockchain-split-payment/piloto
    ```
...
3.  **Instale o Foundry (se ainda não tiver):**
    ```bash
...
4.  **Crie um arquivo `.env` na raiz da pasta `piloto/`:**
    Este arquivo armazenará sua URL de RPC da Polygon.
    ```env
    POLYGON_MAINNET_RPC_URL="https://polygon-rpc.com"
    # Ou use um provedor como Alchemy/Infura para maior confiabilidade:
    # POLYGON_MAINNET_RPC_URL="https://polygon-mainnet.g.alchemy.com/v2/SUA_CHAVE_ALCHEMY"
    ```
...
```
# 5. Análise de Segurança com Mythril
